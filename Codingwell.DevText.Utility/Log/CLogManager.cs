...
namespace Codingwell.DevText.Utility {
	public class CLogManager {
		...
		public static ICLog Exists ( string name ) {
		...
		public static ICLog Exists ( string domain, string name ) {
		...
		public static ICLog Exists ( Assembly assembly, string name ) {
		...
		public static ICLog[] GetCurrentLoggers ( ) {
		...
		public static ICLog[] GetCurrentLoggers ( string domain ) {
		...
		public static ICLog[] GetCurrentLoggers ( Assembly assembly ) {
		...
		public static ICLog GetLogger ( string name ) {
		...
		public static ICLog GetLogger ( string domain, string name ) {
		...
		public static ICLog GetLogger ( Assembly assembly, string name ) {
		...
		public static ICLog GetLogger ( Type type ) {
		...
		public static ICLog GetLogger ( string domain, Type type ) {
		...
		public static ICLog GetLogger ( Assembly assembly, Type type ) {
		...
		private static ICLog WrapLogger ( ILogger logger ) {

			return (ICLog)s_wrapperMap.GetWrapper(logger);
		...
		private static ICLog[] WrapLoggers ( ILogger[] loggers ) {

			ICLog[] results = new ICLog[loggers.Length];
